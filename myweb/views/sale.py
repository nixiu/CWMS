...
def index(request,pIndex):
    ...
    if kw:
        # 查询商家名称/电话只要含有关键字的都可以
        cs = cs.filter(Q(cor__cor_name__contains=kw)|Q(cor__cor_phone__contains=kw))
    ...
    # 封装信息加载模板
    context= {"orderlist":list2, 'plist':plist, 'pIndex':pIndex, 'maxpages':maxpages, 'mywhere':mywhere,'date': date_filter}
